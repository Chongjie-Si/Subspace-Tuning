...
For instance, under the LLaMA-7B backbone with $r=16$, LoMAP achieves an average accuracy of 77.9, substantially improving over LoRA (70.9); no DoRA result is reported at this rank setting.
At $r=32$, LoMAP reaches 78.8, surpassing both DoRA (78.4) and LoRA-Dash (78.4) under similar parameter budgets.
