#!/bin/bash
# Ablation: epsilon sensitivity for MAP normalization
# Tests eps in {1e-8, 1e-6, 1e-4, 1e-2} on LLaMA-7B commonsense reasoning (r=16)
...
for EPS in 1e-8 1e-6 1e-4 1e-2; do
    OUTPUT_DIR="./output/ablation/eps_${EPS}"
    echo "=== eps=$EPS ==="
